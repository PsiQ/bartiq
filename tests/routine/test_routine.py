...
Test cases for Routine (excluding serialization/deserialization).
"""
...
class TestRoutineWalkRespectsDepthFirstTopologicalOrder:
    ...
    def test_parent_is_visited_after_children_are_visited(self):
        ...
        assert visited_names in [
            ...
            ["a", "d", "c", "b", "root"],  # Same, but b's children are in different order
            ["c", "d", "b", "a", "root"],  # b visited before a
            ["d", "c", "b", "a", "root"],  # Same, but b's children are in different order
        ]
